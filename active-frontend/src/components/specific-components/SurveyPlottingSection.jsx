  ...
  return (
    <div>
        ...
        <div className="flex mx-10 h-auto justify-center">
          <div className="">
            <h2 className="bg-amber-50 p-5 font-thin text-3xl text-gray-700">
              Survey & Plotting
            </h2>
            <h1 className="pt-5 px-4 text-2xl w-[80%] text-amber-600">
            ...
            <button
              class="bg-amber-500 hover:bg-amber-400 hover:shadow-sm hover:shadow-amber-300 text-white font-bold p-4 mx-5 mt-10 rounded-md transition duration-100 ease-in-out"
