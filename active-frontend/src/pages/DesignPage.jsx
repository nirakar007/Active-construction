      ...
      <Reveal>
        <div className="flex flex-col gap-5 mx-4">
          ...
          <div className="flex flex-col items-center justify-center mt-20">
            <h1 className="text-2xl font-semibold font-jost ">
              Interior Design
            </h1>
          ...
          <div className="flex flex-col items-center justify-center mt-20 mb-10">
            ...
            <div className="flex gap-2 px-16 rounded-full">
              <div className="flex flex-col items-center justify-center mb-10 bg-sky-50 p-6 shadow-sm rounded-md hover:shadow-md mt-16 hover:scale-105 transition duration-200">
                <h2 className="font-medium text-xl font-jost mb-2">
              ...
              <div className="flex flex-col items-center justify-center mb-10 bg-teal-50 p-6 shadow-sm rounded-md hover:shado mt-16 hover:scale-105 transition duration-200">
                <h2 className="font-medium text-xl font-jost mb-2">Integrated Approach:</h2>
                <p className="font-light pt-2">
                  Seamlessly blend interior and exterior aesthetics.
                </p>
              </div>
              <div className="flex flex-col items-center justify-center mb-10 bg-sky-50 p-6 shadow-sm rounded-md hover:shadow-md mt-16 hover:scale-105 transition duration-200">
                <h2 className="font-medium text-xl font-jost mb-2">Functional Elegance:</h2>
                <p className="font-light pt-2">
              ...
              <div className="flex flex-col items-center justify-center mb-10 bg-teal-50 p-6 shadow-sm rounded-md hover:shado mt-16 hover:scale-105 transition duration-200">
                <h2 className="font-medium text-xl font-jost mb-2">Quality Craftsmanship:</h2>
                <p className="font-light pt-2">
